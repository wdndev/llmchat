import type { MessageProps, ConversationProps, ProviderProps } from '@/renderer/types/chat.types'
...
export const testConversations: ConversationProps[] = [
...
export const testProviders: ProviderProps[] = [
  {     
    id: 1,
    name: 'qianfan',
    title: '百度千帆',
